...
tm.reg <- share_avg ~ extra2 + crra + I(extra2*crra) + female + edad + 
  edu_secondary + edu_prep + 
  factor(game_order) + practice_game + ball + read_write + lottery_winnings
...
cvl <- c("MXN 3000 Additional Income", "CRRA", "Additional Income * CRRA", "Female (1=Yes)", "Age", 
...
t.path.paper.out1 <- str_c(t.path.paper, "participant_level_outcomes_crra.tex")
t.path.slides.out1 <- str_c(t.path.slides, "participant_level_outcomes_crra.tex")

stargazer(cms.reg.tm, cms.reg.em, cms.reg.im,
            title = "Participant Level Outcomes Moderated by CRRA",
...
t.path.paper.out2 <- str_c(t.path.paper, "participant_level_outcomes_crra_coop.tex")
t.path.slides.out2 <- str_c(t.path.slides, "participant_level_outcomes_crra_coop.tex")
...
stargazer(cms.reg.tm.coop, cms.reg.em.coop, cms.reg.im.coop,
            title = "Participant Level Outcomes Moderated by CRRA (Cooperative Members)",
...
t.path.paper.out3 <- str_c(t.path.paper, "participant_level_outcomes_crra_coop_no.tex")
t.path.slides.out3 <- str_c(t.path.slides, "participant_level_outcomes_crra_coop_no.tex")
...
stargazer(cms.reg.tm.coop.no, cms.reg.em.coop.no, cms.reg.im.coop.no,
            title = "Participant Level Outcomes Moderated by CRRA (Cooperative Non-Members)",
